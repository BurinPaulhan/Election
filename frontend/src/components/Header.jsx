...
const navigation = [['Accueil', '#accueil'], ['À propos', '#a-propos'], ['Vision', '#vision'], ['Programme', '#programme'], ['Équipe', '#equipe'], ['Actualités', '#actualites']]
...
function Header({ isMenuOpen, onMenuToggle, onNavigate }) {
  ...
  return <header className={isScrolled || isMenuOpen ? 'site-header is-scrolled' : 'site-header'}><div className="header-inner container">
    <a className="brand" href="#accueil" onClick={onNavigate} aria-label="Patrick Rakoto, retour à l'accueil"><img src={aemaLogo} alt="Logo de l’AEMA" /><span className="wordmark"><span>Patrick</span> RAKOTO</span></a>
